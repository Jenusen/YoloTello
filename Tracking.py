...
# Load YOLOv5 model
# model = torch.hub.load('ultralytics2/yolov5', 'custom', path='best.pt')

# model = torch.hub.load('E:/pycharmFile/Camera/yolov5_Monocular_ranging-main_v1/ultralytics2/yolov5', model='models/yolov5s.yaml',source='local', path='E:/pycharmFile/Camera/yolov5_Monocular_ranging-main_v1/yolov5_Monocular_ranging-main/runs/train/exp27/weights/best.pt',device=0)
# model = torch.hub.load('E:/pycharmFile/Camera/yolov5_Monocular_ranging-main_v1/yolov5_Monocular_ranging-main/ultralytics2/yolov5', 'custom', path='E:/pycharmFile/Camera/yolov5_Monocular_ranging-main_v1/yolov5_Monocular_ranging-main/runs/train/exp27/weights/best.pt',source='local')

model = torch.hub.load('E:/pycharmFile/ObjectTracking1/vision-based-object-detection/ultralytics/yolov5', 'custom', path='E:/pycharmFile/Camera/yolov5_Monocular_ranging-main_v1/yolov5_Monocular_ranging-main/runs/train/exp27/weights/best.pt', source='local')
'E:/pycharmFile/ObjectTracking1D/vision-based-object-detection/ultralytics/yolov5'
